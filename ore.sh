...
start="while true; do ./orenew --rpc $RPC_URL --keypair ~/.config/solana/id.json --priority-fee $PRIORITY_FEE mine --threads $THREADS; echo '进程异常退出，等待重启' >&2; sleep 1; done"
...
start_command_template="while true; do /orenew --rpc $rpc_address --keypair ~/.config/solana/idX.json --priority-fee $priority_fee mine --threads $threads; echo '进程异常退出，等待重启' >&2; sleep 1; done"
...
# 启动命令模板
start_command_template="while true; do /orenew --rpc $rpc_address --keypair {} --priority-fee $priority_fee mine --threads $threads; echo '进程异常退出，等待重启' >&2; sleep 1; done"
